...
class App {
    ...
    executarOpcao(opcao) {
        switch (opcao) {
            ...
            case '06':
                ...
                break;
            case '07':
                this.transferirMultiplas();
                break;
            case '08':
                console.log('Quantidade de contas:', this.banco.quantidadeContas());
                break;
            case '09':
                console.log('Total de dinheiro no banco: R$', this.banco.totalDinheiro());
                break;
            case '10':
                console.log('Média dos saldos:', this.banco.mediaSaldos());
                break;
            case '11':
    ...
    inserirConta() {
        ...
        const conta = new banco_1.Conta(id, numero, new Date(), saldo);
    ...
    consultarConta() {
        ...
        if (conta)
            console.log(`Conta: ${conta.numero} | Saldo: R$${conta.saldo} | Cliente: ${(_b = (_a = conta.cliente) === null || _a === void 0 ? void 0 : _a.nome) !== null && _b !== void 0 ? _b : 'Sem cliente'}`);
        else
    ...
    listarContasSemCliente() {
        ...
        if (semCliente.length === 0)
            ...
            for (let conta of semCliente)
                console.log(`- Conta nº ${conta.numero}`);
            for (let conta of semCliente) {
    ...
    inserirCliente() {
        ...
        const cliente = new banco_1.Cliente(id, nome, cpf, nasc);
